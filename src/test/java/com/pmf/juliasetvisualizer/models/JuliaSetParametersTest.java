...
class JuliaSetParametersTest {
    ...
    void mapBrojStoToRealToPetSto() {
        JuliaSetParameters noviparametri=new JuliaSetParameters(0, 0, 1,0, 0, 100,0);
    ...
    @Test
    void getCentarXSto() {
        JuliaSetParameters noviparametri=new JuliaSetParameters(100, 0, 1,0, 0, 100,0);
    ...
    @Test
    void getCentarYSto() {
        JuliaSetParameters noviparametri=new JuliaSetParameters(0, 100, 1,0, 0, 100,0);
    ...
    @Test
    void getZoomDeset() {
        JuliaSetParameters noviparametri=new JuliaSetParameters(0, 0, 10,0, 0, 100,0);
        assertEquals(10,noviparametri.getZoom());
    }
    @Test
    void getZoomSto() {
        JuliaSetParameters noviparametri=new JuliaSetParameters(0, 0, 100,0, 0, 100,0);
    ...
    @Test
    void getCRealDeset() {
        JuliaSetParameters noviparametri=new JuliaSetParameters(0, 0, 1,10, 0, 100,0);
        assertEquals(10,noviparametri.getcReal());
    }
    @Test
    void getCRealSto() {
        JuliaSetParameters noviparametri=new JuliaSetParameters(0, 0, 1,100, 0, 100,0);
    ...
    @Test
    void getCImagDeset() {
        JuliaSetParameters noviparametri=new JuliaSetParameters(0, 0, 1,0, 10, 100,0);
        assertEquals(10,noviparametri.getcImaginary());
    }
    @Test
    void getCImagSto() {
        JuliaSetParameters noviparametri=new JuliaSetParameters(0, 0, 1,0, 100, 100,0);
        assertEquals(100,noviparametri.getcImaginary());
    }
    @Test
    void getMaxIterJedan() {
        JuliaSetParameters noviparametri=new JuliaSetParameters(0, 0, 1,0, 0, 1,0);
        assertEquals(1,noviparametri.getMaxIterations());
    }
    @Test
    void getMacIterDeset() {
        JuliaSetParameters noviparametri=new JuliaSetParameters(0, 0, 1,0, 10, 10,0);
    ...
    void getMacIterTisucu() {
        JuliaSetParameters noviparametri=new JuliaSetParameters(0, 0, 1,0, 100, 1000,0);
